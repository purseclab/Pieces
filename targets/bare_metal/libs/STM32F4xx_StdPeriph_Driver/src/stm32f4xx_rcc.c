...
static __I uint8_t APBAHBPrescTable checked[16] = {0, 0, 0, 0, 1, 2, 3, 4, 1, 2, 3, 4, 6, 7, 8, 9};
...
#else
void RCC_GetClocksFreq(_Ptr<RCC_ClocksTypeDef> RCC_Clocks)
#endif
{
...
static  __I uint8_t AHBPrescTable checked[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
